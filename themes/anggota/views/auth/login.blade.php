    ...
    <main class="form-signin">
        <form method="POST" action="{{ route('anggota.login') }}">
            ...
            <div class="checkbox mb-3">
                <label>
                <input type="checkbox" name="remember" id="remember" value="remember-me" {{ old('remember') ? 'checked' : '' }}> Remember me
                </label>
            </div>
        ...
        <p class="mt-3">
            <a href="{{ route('admin.login') }}" class="text-center">sign in as admin</a>
        </p>
    </main>
